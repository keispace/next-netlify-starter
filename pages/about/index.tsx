      ...
      <main>
        ...
        <div className={style.bg3}>
          ...
          <div className={style.history}>
            ...
            <div className={style.left}></div>
            <div className={style.right}>
              <img src="/about/bg4-ring.png" /> <mark>2012</mark> <p>하루 생산량 2만2천구 생산</p>
            </div>
            <div className={style.left}>
            ...
            <div className={style.left}></div>
            <div className={style.right}>
              <img src="/about/bg4-ring.png" /> <mark>2015</mark> <p>평사농장 증설 일 생산량 5만구 생산</p>
            </div>
            <div className={style.left}>
        ...
        <div className={style.bg4}>
          <div className={style.texts}>
            ...
            <h2>파트너사</h2>
            <h5>농업회사법인마음은 신선하고 안전한 제품을 위해 국내 및 해외 파트너들과 함께 뛰고 있습니다.</h5>
          </div>
